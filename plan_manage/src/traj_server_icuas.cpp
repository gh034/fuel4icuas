...
ros::Publisher cmd_vis_pub, pos_cmd_pub, traj_pub, pos_icuas_pub;
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "traj_server_icuas");
  ros::NodeHandle node;
  ros::NodeHandle nh("~");
  ...
  pos_icuas_pub = node.advertise<trajectory_msgs::MultiDOFJointTrajectoryPoint>("/red/position_hold/trajectory", 10);

  std::cout << "DID YOU EVER CALLED CMDCALLBACK ONCE ? ? ? ?" << std::endl;
